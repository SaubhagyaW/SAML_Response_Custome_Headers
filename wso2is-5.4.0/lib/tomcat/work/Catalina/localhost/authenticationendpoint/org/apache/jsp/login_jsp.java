...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/basicauth.jsp", Long.valueOf(1512641132000L));
    _jspx_dependants.put("/openid.jsp", Long.valueOf(1512641132000L));
    _jspx_dependants.put("/tenantauth.jsp", Long.valueOf(1512641132000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /login.jsp(38,2) name = basename type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(request.getParameter("relyingParty").equals("wso2.my.dashboard")) { 
            ...
            out.write("\n");
            out.write("<script>\n");
            out.write("        function submitCredentials () {\n");
 ...
 if (Boolean.parseBoolean(loginFailed)) { 
        ...
        if (reCaptchaEnabled) {
            ...
            out.write("            <button\n");
            out.write("                    class=\"wr-btn grey-bg col-xs-12 col-md-12 col-lg-12 uppercase font-extra-large\"\n");
            out.write("                    type=\"submit\" onclick=\"submitCredentials()\">Sign in\n");
            out.write("            </button>\n");
            out.write("        </div>\n");
            out.write("    </div>\n");
            out.write("    <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group\">\n");
...
if (idpAuthenticatorMapping != null &&
 ...
 if (isHubIdp) { 
            ...
            out.write("\">\n");
            out.write("                                    <img class=\"idp-image\" src=\"images/login-icon.png\" data-toggle=\"tooltip\"\n");
            out.write("                                         data-placement=\"top\" title=\"Sign in with TOTP\"/>\n");
            out.write("                                </a>\n");
            out.write("                                <label for=\"icon-");
            out.print(iconId);
